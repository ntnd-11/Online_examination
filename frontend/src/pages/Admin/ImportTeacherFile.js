...
function ImportTeacherFile() {
    ...
    const handleUploadFile = () => {
        setIsLoading(true);
        TeacherAdminService.import(file)
            .then((response) => {
                setIsLoading(false);
    ...
    const handleDownLoadTemplate = () => {
        ...
        AdminService.downloadImportTeacherTemplate()
            .then((response) => {
                const url = window.URL.createObjectURL(new Blob([response]));
                const link = document.createElement('a');
                link.href = url;
                link.setAttribute('download', 'import-teachers-template.xlsx');
                ...
                <Box>
                    ...
                    <FormControl mr={8} display={'flex'} justifyContent={'center'} alignItems={'center'}>
                        ...
                        >
                            ...
                            Tải lên file giảng viên tại đây
                        </FormLabel>
                        <Input
...
export default ImportTeacherFile;
